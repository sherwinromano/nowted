<x-archived-layout>
    <x-slot name="noteList">
        <x-note-list :title="$note_title" :datas="$archives" containerClass="flex flex-col gap-2 h-full mt-4" />
    </x-slot>
    <x-note-list :title="$note_title" :datas="$archives" containerClass="xs:hidden md:flex flex-col gap-7 px-5 py-7 bg-[#1c1c1c] w-[50%]" />
